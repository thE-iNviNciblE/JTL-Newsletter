Public Class frmDatenbankEinstellungen
    ...
    Private Sub cmbMandant_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbMandant.SelectedIndexChanged
        ...
        If bConnected = True And bIsLoading = False Then
            ...
            My.Settings.mandant_position = frmMain.getMySettingsPositionByDatabase(frmMain.clsDB.getMandantDatabaseByMandantName(cmbMandant.Text))
            msgMaster.Text = "Bei Einstellung: " & cmbMandant.Text & " (" & My.Settings.mandant_position & ")"

            '# Fehler es wird das aktuelle Profil nicht gefunden
            If My.Settings.mandant_position = -1 Then
                ...
                '# Ändern der Combobox auf aktuellen eintrag
                'bIsLoading = True
                ' cmbMandant.SelectedIndex = frmMain.getCmbPositionByName(cmbMandant, "eazybusiness")
                '  bIsLoading = False

                '# Wird das Standarddatenbankprofil nicht gefunden wird empfohlen die Standarddatenbank anzulegen
                If My.Settings.mandant_position = -1 Then
